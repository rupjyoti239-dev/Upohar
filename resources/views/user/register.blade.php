...
@section('main-section')
    ...
    <div class="my-28 w-11/12 md:w-2/5 px-10 py-14 rounded-md mx-auto bg-blue-200">
        ...
        <form class="max-w-sm mx-auto" action="{{ route('user.register.post') }}" method="post">
            @csrf
            <div class="mb-5">
            ...
            <p class="text-center text-md-center mt-3">Already have an account? <a class="text-blue-600"
